...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{figures_supp/dataset_e-flare.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{figures_supp/dataset_e-flare-r.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{figures_supp/dataset_dsec-flare.pdf}
...
\begin{figure}[H]
    ...
    \caption{\textbf{Extreme and static-flare cases.}}
    \label{APfig:supp_3}
\end{figure}
