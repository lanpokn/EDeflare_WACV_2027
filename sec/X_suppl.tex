...
A Prophesee EVK4-HD event camera ($1280 \times 720$) is used with a custom rig of removable optical filters (six-point star filter and random-pattern filters). High-intensity light sources — a frequency-controllable point light and a square Tungsten lamp — are placed within the FoV to produce diverse flare artifacts.
