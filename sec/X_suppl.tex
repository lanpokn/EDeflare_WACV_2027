...
\newcommand{\suppdatasetfig}[1]{\includegraphics[width=0.96\textwidth,height=0.50\textheight,keepaspectratio]{#1}}
\newcommand{\supptallfig}[1]{\includegraphics[width=\textwidth,height=0.76\textheight,keepaspectratio]{#1}}
...
\begin{figure}[!t]
    \centering
    \suppdatasetfig{figures_supp/dataset_e-flare.pdf}
...
\begin{figure}[!t]
    \centering
    \suppdatasetfig{figures_supp/dataset_e-flare-r.pdf}
...
\begin{figure}[!t]
    \centering
    \suppdatasetfig{figures_supp/dataset_dsec-flare.pdf}
...
%%     Keep the updated notation: ξ(t)/Φ(τ), without E_ideal.
%% ============================================================
...
\begin{figure}[!p]
    \centering
    \supptallfig{figures_supp/simu_R_supp_1.pdf}
...
\begin{figure}[!p]
    \centering
    \supptallfig{figures_supp/simu_R_supp_2.pdf}
...
\begin{figure}[!p]
    \centering
    \supptallfig{figures_supp/simu_R_supp_3.pdf}
