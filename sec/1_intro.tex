...
\begin{itemize}
    ...
    \item We use a standard 3D U-Net, \textbf{E-DeflareNet}, to validate the proposed physical formulation and paired data, showing that training on our data yields strong de-flaring performance and improves downstream imaging.
\end{itemize}
