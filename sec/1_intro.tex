...
\begin{itemize}
    ...
    \item We use a standard 3D U-Net, \textbf{E-DeflareNet}, to validate the proposed physical formulation and paired data, showing that training on our generated data yields strong de-flaring performance and improves downstream event camera imaging.
\end{itemize}
