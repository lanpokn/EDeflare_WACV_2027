...
\begin{itemize}
    ...
    \item We present \textbf{E-DeflareNet}, demonstrating that a standard network trained on our physically grounded data suffices to outperform all existing baselines and to improve downstream task performance.
\end{itemize}
